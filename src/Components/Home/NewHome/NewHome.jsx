        ...
        <div className="h-full lg:px-20 md:px-6 xl:px-[5px] ">
          <div className="NewHome_div_section1_area w-full">
            <div className=" flex flex-col  mt-32 text-white gap-4 ">
              <div className=" text-start xl:text-6xl md:text-5xl text-white flex text-3xl flex-col font-extrabold ">
                Global Leader
                <span>Veteran Asset</span>
                <span>Perfection</span>
                <span>Assurance and Training</span>
                Solutions
              </div>
              <div className="md:w-2/4">
                As a Quality Assured organization, we are ISO 9001:2015
                certified, delivering world-class training solutions tailored to
                the oil & gas, marine, and construction industries. Our
                commitment to excellence ensures the highest standards of
                professional development and operational integrity.
              </div>
              <div className="">
                <a
                  href="/#contact-us"
                  class="group relative inline-flex h-[calc(48px+8px)] items-center justify-center rounded-full bg-neutral-950 py-1 pl-6 pr-14 font-medium text-neutral-50"
                >
                  <span class="z-10 pr-2">Contact Us</span>
