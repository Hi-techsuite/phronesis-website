...
const KnowledgeBank = () => {
  return (
    <div>
      <section className="">
        <div
          className="text-start bg-[#8a97ab] md:bg-right-top bg- bg-blend-multiply text-white  xl:text-6xl md:text-5xl flex justify-center items-center max-h-[40dvh] h-screen text-3xl flex-col font-extrabold "
          style={{ backgroundImage: "url('/new_img/crane-2.jpg')" }}
        >
      ...
      >
        <section>
          <div className="flex  w-4/5 mx-auto py-20 gap-10 flex-col xl:flex-row">
            <div className="">
              <ReactPlayer
